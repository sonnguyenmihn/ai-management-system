    ...
    return (
        ...
        <div className="navbar">
            ...
            <div className="navbar-right">
                <a className="navbar-title" href="/dashboard">Dashboard</a>
                <a className="navbar-title" href="/history">History</a>
                <a className="navbar-title" href="/servicerequest">Request</a>
                <a className="navbar-title" href="/services">Services</a>
                <a className="navbar-title" onClick={handleClick}>Sign out</a>
            </div>
        </div>
        </div>
